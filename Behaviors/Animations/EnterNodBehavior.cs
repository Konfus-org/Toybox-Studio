...
/// field the wiggle uses (<see cref="TextWiggleBehavior.ResolveTarget"/>, so the SearchBox pill / NumericUpDown well
...
public static class EnterNodBehavior
{
    ...
    private static void Nod(TextBox box)
    {
        ...
        var target = TextWiggleBehavior.ResolveTarget(box);
