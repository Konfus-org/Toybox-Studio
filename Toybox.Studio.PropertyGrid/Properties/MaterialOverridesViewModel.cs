...
public sealed partial class MaterialOverridesViewModel : PropertyViewModel
{
    ...
    public MaterialOverridesViewModel(
        PropertyDescriptor descriptor, IValueAccessor accessor, ulong materialId, Action? commit, int depth)
        : base(descriptor, accessor)
    {
        ...
        var body = accessor.Get() as JObject;
    ...
    /// </summary>
    public async Task ReloadBaseAsync(ulong materialId)
    {
        Parameters.Clear();
        Textures.Clear();
        NotifyCounts();
