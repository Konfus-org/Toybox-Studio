...
/// <summary>
/// Serves the vendored Monaco bundle (copied to the output under <c>ScriptEditor/Monaco</c>) over a loopback
...
public sealed class MonacoAssetServer : IDisposable
{
    ...
    {
        _log = log;
        _root = Path.Combine(AppContext.BaseDirectory, "ScriptEditor", "Monaco");
    }
