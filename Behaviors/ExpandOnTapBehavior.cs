...
/// <c>util:ExpandOnTapBehavior.Enabled="True"</c> on the row's body, NOT the whole row, so the chevron/delete handle
/// their own taps without double-toggling.
/// </summary>
public static class ExpandOnTapBehavior
{
    public static readonly AttachedProperty<bool> EnabledProperty =
        AvaloniaProperty.RegisterAttached<Control, bool>("Enabled", typeof(ExpandOnTapBehavior));

    static ExpandOnTapBehavior()
    {
