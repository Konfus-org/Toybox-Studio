...
/// </summary>
public static class PointerEnterCommand
{
    public static readonly AttachedProperty<ICommand?> CommandProperty =
        AvaloniaProperty.RegisterAttached<Control, ICommand?>("Command", typeof(PointerEnterCommand));

    static PointerEnterCommand()
    {
