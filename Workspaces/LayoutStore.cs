...
/// <summary>
/// Persists dock layouts as JSON under <c>~/.toybox/Layouts</c>, purely by name — which name means what
...
{
    private static readonly string LayoutsDirectory = Path.Combine(SettingsManager.BaseDirectory, "Layouts");
    ...
    private static IReadOnlyList<string> ListNames()
    {
