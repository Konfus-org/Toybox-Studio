...
/// </summary>
public sealed class EngineInstanceDetector : IDisposable
{
    ...
    public EngineInstanceDetector(EngineSession session)
    {
        _session = session;
    }
    ...
    private async Task ProbeLoopAsync(CancellationToken ct)
    {
        while (!ct.IsCancellationRequested)
        {
            ...
            if (_session.State == EngineConnectionState.Disconnected)
            {
