...
/// <summary>
/// Runs a command when the pointer leaves a control — the companion to <see cref="PointerEnterCommand"/>, used
/// to dismiss the browser's hover-preview card once the pointer leaves the asset grid.
/// </summary>
public static class PointerExitCommand
{
    public static readonly AttachedProperty<ICommand?> CommandProperty =
        AvaloniaProperty.RegisterAttached<Control, ICommand?>("Command", typeof(PointerExitCommand));

    static PointerExitCommand()
    {
