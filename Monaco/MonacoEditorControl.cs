...
/// document state lives on the session and the shared <c>ScriptDocument</c>; this control is just the
...
/// composites with surrounding Avalonia content instead of floating above it (native airspace) — for an
/// embedded strip that sits inside a scrolling panel. The dockable window leaves it native (faster).
/// </summary>
