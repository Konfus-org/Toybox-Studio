...
public sealed class EngineSyncGenerator : IIncrementalGenerator
{
    ...
    private static SyncedField? Describe(GeneratorAttributeSyntaxContext ctx)
    {
        ...
        return new SyncedField(
            ...
            string.IsNullOrEmpty(wireOverride) ? ToSnakeCase(property) : wireOverride!,
    ...
    // PascalCase -> snake_case: lowercase, inserting '_' before each uppercase that follows a lowercase or digit.
