...
public sealed partial class MaterialSlotViewModel : ObservableObject
{
    ...
    private static string? ReadName(JObject entry) => entry["name"].Unwrap()?.Value<string>();
    ...
    private void RebuildEditor()
    {
        ...
        var (descriptor, accessor) = JsonDescriptorReader.ReadValue(_name, _wrapper, OnEdited);
        var editor = PropertyViewModelFactory.Create(descriptor, accessor, _depth);
