...
/// <see cref="TransformOperations"/> (the there-and-back nod in <see cref="ExpandNodBehavior"/>). Avalonia 12's built-in
...
/// <see cref="PopBehavior"/> uses), not the keyframe path — so a keyframe setter on <c>RenderTransform</c> throws
