...
/// </summary>
public static class RowEntranceBehavior
{
    public static readonly AttachedProperty<bool> EnabledProperty =
        AvaloniaProperty.RegisterAttached<Control, bool>("Enabled", typeof(RowEntranceBehavior));
    ...
    public static readonly AttachedProperty<Animation?> AnimationProperty =
        AvaloniaProperty.RegisterAttached<Control, Animation?>("Animation", typeof(RowEntranceBehavior));

    static RowEntranceBehavior()
    {
