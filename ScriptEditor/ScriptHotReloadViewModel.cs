...
/// </summary>
public sealed partial class ScriptHotReloadViewModel : ObservableObject, IDisposable
{
    ...
    public ScriptHotReloadViewModel(SettingsManager settings, ProjectBuilder builder, Logger log)
    {
        _settings = settings;
        _builder = builder;
        _log = log;
