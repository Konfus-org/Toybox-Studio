...
/// over its neighbours); the directional expand/collapse nod is a separate concern (<see cref="ExpandNodBehavior"/>).
///
...
/// </summary>
public static class PopBehavior
{
    public static readonly AttachedProperty<bool> EnabledProperty =
        AvaloniaProperty.RegisterAttached<Control, bool>("Enabled", typeof(PopBehavior));
