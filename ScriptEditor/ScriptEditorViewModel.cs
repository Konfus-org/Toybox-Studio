...
public sealed partial class ScriptEditorViewModel : ObservableObject, IDisposable
{
    ...
    private readonly ScriptHotReloadViewModel _hotReload;
...
""";
    ...
    public ScriptEditorViewModel(
        MonacoAssetServer server, ScriptService documents, ProjectManager projects,
        EngineLocator locator, ScriptHotReloadViewModel hotReload, ThemeManager theme, SettingsManager settings, Logger log)
    {
        ...
        Session.SetTheme(_theme.Active.IsDark);
    ...
    public ScriptHotReloadViewModel HotReload => _hotReload;
    ...
    private void OnThemeChanged() => Session?.SetTheme(_theme.Active.IsDark);
