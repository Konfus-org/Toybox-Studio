...
/// (button press/hover in ButtonStyle, toggle tilt in InputStyle) and the <c>TextWiggleBehavior</c> behavior all read
...
public static class MotionTokens
{
    ...
    public static void Publish(double intensity)
    {
        ...
        // The toggle "tip" is a one-shot reactive animation driven by the ToggleTipBehavior behavior (which reads the
