...
/// selection. Like <see cref="WorldTree.DragDrop"/>, it is entity-aware so it can resolve ids to the row
...
public static class Selection
{
    public static readonly AttachedProperty<WorldSelection?> SelectionProperty =
        AvaloniaProperty.RegisterAttached<Control, WorldSelection?>("Selection", typeof(Selection));
    ...
    static Selection() => SelectionProperty.Changed.AddClassHandler<Control>(OnSelectionChanged);
