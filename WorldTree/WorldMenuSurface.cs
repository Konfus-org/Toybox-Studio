...
/// <summary>
/// The world surface a context menu opened over. It governs the tree-only rows (inline rename) that are
/// view-layer actions the world tree owns and make no sense over the 3D viewport.
/// </summary>
