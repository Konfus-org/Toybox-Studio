...
/// settings (or other data) update without polling. Implemented by <c>SettingsManager</c> (editor settings)
/// and the engine-mirrored objects (<c>EngineObject</c>). Subscribe with
