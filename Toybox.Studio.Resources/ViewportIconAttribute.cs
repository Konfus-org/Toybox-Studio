...
/// <summary>
/// The billboard icon a reflected component shows at its entity's position in editor viewports. Like the
/// <c>[Icon]</c> attribute, this is editor-defined, not engine-supplied: <paramref name="name"/> is a
