...
/// to the built-in default — mirroring how <see cref="Settings"/> recovers from a bad settings file.
/// </summary>
public sealed class LayoutStore
{
    private static readonly string LayoutsDirectory = Path.Combine(Settings.BaseDirectory, "Layouts");
