...
/// to. Each method is a thin opener over a self-contained MVVM dialog in <c>Dialogs</c>.
/// </summary>
public static class Popups
{
    ...
    public static async Task ShowErrorAsync(string title, string message)
    {
        if (MainWindow() is not { } owner)
            return;
        await MessageDialog.ShowAsync(owner, title, message, Icon.CircleAlert, Colors.Red).ContinueOnAnyContext();
    }
