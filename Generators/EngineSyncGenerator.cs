...
/// marked partial properties (backing field, notify, push per <c>SyncMode</c>, inbound apply) and
/// partial methods (engine commands, optionally wrapped in relay commands), and injects the
/// <c>EngineObject</c> base so user code never inherits it by hand. See
